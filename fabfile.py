"""
Starter fabfile for deploying the glance project.
...
# CHANGEME
env.hosts = ['user@glance.example.com']
env.code_dir = '/srv/www/glance'
env.project_dir = '/srv/www/glance/glance'
env.static_root = '/srv/www/glance/static/'
env.virtualenv = '/srv/www/glance/.virtualenv'
env.code_repo = 'git@github.com:user/glance.git'
env.django_settings_module = 'glance.settings'
